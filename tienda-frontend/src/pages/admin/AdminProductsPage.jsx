...
export default function AdminProductsPage() {
  ...
  return (
    <>
      <PageHeader eyebrow="Administración" title="Productos" description="Administra inventario, precios y disponibilidad." actions={<button className="button button-secondary" onClick={reset} type="button">Nuevo producto</button>} />
